...
public:
    void setParameters(float l, float T, float K, float LAMBDA, float U, float W, float ALFA, float S, float N)
    {
        ...
        parameters[T_const1] = T;
        parameters[K_const2] = K;
        parameters[LAMBDA_const3] = LAMBDA;
        parameters[U_const4] = U;
        parameters[W_const5] = W;
        parameters[ALFA_const6] = ALFA;
        parameters[S_const7] = S;
        parameters[N_const8] = N;
    }
