...
{
    float T = m.getParameter(T_const1);
    A.at(0).at(0) += -T / 8;
    A.at(0).at(1) += T / 8;
    A.at(1).at(0) += -T / 8;
    A.at(1).at(1) += T / 8;
...
{
    float ALFA = m.getParameter(ALFA_const6);
...
{
    float LAMBDA = m.getParameter(LAMBDA_const3);
...
{
    float S = m.getParameter(S_const7);
    I.at(0).at(0) += -S / 2.0;
    I.at(0).at(1) += S / 2.0;
    I.at(1).at(0) += -S / 2.0;
    I.at(1).at(1) += S / 2.0;
...
void createLocalP(Matrix &P, mesh m)
{
    ...
    float K = m.getParameter(K_const2);
    P.at(0).at(0) += K / l;
    P.at(0).at(1) += -K / l;
    P.at(1).at(0) += -K / l;
    P.at(1).at(1) += K / l;
...
{
    float l = m.getParameter(ELEMENT_LENGTH);
    float U = m.getParameter(U_const4);
    Q.at(0).at(0) += U / l;
    Q.at(0).at(1) += -U / l;
    Q.at(1).at(0) += -U / l;
    Q.at(1).at(1) += U / l;
...
Vector createLocalb(int element, mesh &m)
{
    ...
    float W = m.getParameter(W_const5), N = m.getParameter(N_const8), l = m.getParameter(ELEMENT_LENGTH);
