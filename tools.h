...
void leerMallayCondiciones(mesh &m)
{
    char filename[14];
    ifstream file;
    float l, T_const1, K_const2, LAMBDA_const3, U_const4, W_const5, ALFA_const6, S_const7, N_const8;
    ...
    file >> l >> T_const1 >> K_const2 >> LAMBDA_const3 >> U_const4 >> W_const5 >> ALFA_const6 >> S_const7 >> N_const8;
    file >> nnodes >> neltos >> ndirich_u >> ndirich_p;

    m.setParameters(l, T_const1, K_const2, LAMBDA_const3, U_const4, W_const5, ALFA_const6, S_const7, N_const8);
